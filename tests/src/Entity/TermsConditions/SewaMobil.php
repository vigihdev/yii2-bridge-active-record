 ...
 * Class SewaMobil
 *
 * Represents the `sewa_mobil` table for car rental terms.
 *
 * @property int $idsewa_mobil The unique identifier
 ...
 */
class SewaMobil extends BaseActiveRecord
{
    #[Required]
    #[Integer]
    public int $idsewa_mobil = 0;
