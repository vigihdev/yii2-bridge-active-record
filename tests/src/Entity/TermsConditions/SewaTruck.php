 ...
 * Class SewaTruck
 *
 * Represents the `sewa_truck` table for truck rental terms.
 *
 * @property int $idsewa_truck The unique identifier
 ...
 */
class SewaTruck extends BaseActiveRecord
{
    #[Required]
    #[Integer]
    public int $idsewa_truck = 0;
